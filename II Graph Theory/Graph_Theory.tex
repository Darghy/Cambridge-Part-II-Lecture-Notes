...
\end{defn}
\textbf{Fact.} Let $G$ be an $r$--partite graph on $n$ vertices. Then $e(G) \le e(T_{r,n})$.
\begin{proof}
...
\end{proof}
\begin{proof}
    Say $V(G)=[n]$. Let $\alpha_1,\ldots,\alpha_r$ be transcendental numbers that are linearly independent over $\mathbb{Q}$ and define $\mu(S) = \sum_{i \in S}^{} \alpha_i$ for $S \subset [n]$.
\end{proof}
