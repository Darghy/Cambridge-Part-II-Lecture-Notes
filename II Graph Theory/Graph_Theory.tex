...
\begin{proof}[Proof idea:]
    Think of $X$ as lines in a finite geometry and $Y$ as points, and we have an edge if a line contains a given point.

    Let $\mathcal{L}= \mathbb{F}_p^2 \setminus \{(0,0)\}$ and $\mathcal{P}=\mathbb{F}_p^2$. For $(a,b) \in \mathcal{L}$ define $N((a,b)) = \{(x,ax+b) \mid x \in \mathbb{F}_p\}$.
\end{proof}
