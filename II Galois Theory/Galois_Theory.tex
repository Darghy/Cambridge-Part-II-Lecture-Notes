...
\begin{lemma}
    Let $C$ be a cyclic group of order $n \ge 2$ (written multiplicatively). If $a \in \mathbb{Z}$ and $(a,n)=1$, then the map $[a] : C \to C$ by $[a]g=g^a$ is an \textbf{automorphism} of $C$, and the map $$(\mathbb{Z}/n\mathbb{Z})^{\times} \to \text{Aut}(c), a \mapsto [a]$$ is an automorphism. 
\end{lemma}
\begin{proof}
